...
initialize('www.quorn.co.uk', { recurse: false }, handlePage)
    .then(async ({ queue }) => {
        await queue({ uri: 'https://www.quorn.co.uk/products/mini-cocktail-sausages' });
        await queue({ uri: 'https://nudefood.co.uk/product/provamel-organic-chocolate-soya-drink-single-carton-250ml/' })
        await queue({ uri: 'https://www.naturli-foods.com/products/chick-free-nuggets/' })
